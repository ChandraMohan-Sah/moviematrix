...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('app3_cast', '0007_delete_castknownfor'),
        ('app4_creator', '0003_remove_creatorcoredetail_children_and_more'),
        ('app5_writer', '0003_remove_writercoredetail_children_and_more'),
