    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('color', 'Color'), ('bw', 'Black and White')], max_length=20)),
                ('sound_mix', models.CharField(choices=[('mono', 'Mono'), ('stereo', 'Stereo'), ('dolby_digital', 'Dolby Digital'), ('dts', 'DTS'), ('dolby_atmos', 'Dolby Atmos'), ('sdds', 'SDDS'), ('auro_3d', 'Auro 3D'), ('imax_6_track', 'IMAX 6-Track')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('removed_at', models.DateTimeField(auto_now=True)),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='watchlisted_by', to='app6_movie.movie')),
